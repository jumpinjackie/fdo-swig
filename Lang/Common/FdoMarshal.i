...
//
%newobject FdoISchemaCapabilities::SupportedClassTypes;
%newobject FdoISchemaCapabilities::SupportedDataTypes;
%newobject FdoISchemaCapabilities::SupportedAutogeneratedDataTypes;
%newobject FdoISchemaCapabilities::SupportedIdentityPropertyTypes;
...
%newobject FdoIFilterCapabilities::SupportedConditionTypes;
%newobject FdoIFilterCapabilities::SupportedSpatialOperations;
%newobject FdoIFilterCapabilities::SupportedDistanceOperations;
...
%newobject FdoIExpressionCapabilities::SupportedExpressionTypes;
...
%newobject FdoIGeometryCapabilities::SupportedGeometryComponentTypes;
%newobject FdoIGeometryCapabilities::SupportedGeometryTypes;
...
%newobject FdoIConnectionCapabilities::SupportedLockTypes;
%newobject FdoIConnectionCapabilities::SupportedSpatialContextExtentTypes;
...
%newobject FdoICommandCapabilities::SupportedCommands;
...
%newobject FdoClassCapabilities::GetSupportedLockTypes;
...
%newobject FdoProviderNameTokens::GetNameTokens;
%newobject FdoProviderNameTokens::GetVersionTokens;
...
%newobject FdoIPropertyDictionary::EnumeratePropertyValues;
%newobject FdoIPropertyDictionary::GetPropertyNames;
...
%newobject FdoIdentifier::GetAttributeNames();
...
%newobject FdoIdentifier::GetScope();
...
%newobject *::GetDataBytes;
%newobject *::GetFgfBytes;
%newobject *::GetWkbBytes;
%newobject *::GetBoundsBytes;
%newobject *::GetExtentBytes;
%newobject *::GetGeometryBytes;
...
%extend FdoBLOBValue
{
    ...
    void SetDataBytes(FdoByteArrayHandle* handle)
    {
        FdoPtr<FdoByteArray> arr = handle->GetInternalArray();
        $self->SetData(arr);
    }
...
%extend FdoGeometryValue
{
    ...
    void SetGeometryBytes(FdoByteArrayHandle* handle)
    {
        FdoPtr<FdoByteArray> arr = handle->GetInternalArray();
        $self->SetGeometry(arr);
    }
...
%extend FdoIRaster
{
    ...
    void SetBoundsBytes(FdoByteArrayHandle* handle)
    {
        FdoPtr<FdoByteArray> arr = handle->GetInternalArray();
        $self->SetBounds(arr);
    }
...
%extend FdoXmlSpatialContextWriter
{
    void SetExtentBytes(FdoByteArrayHandle* handle)
    {
        FdoPtr<FdoByteArray> arr = handle->GetInternalArray();
        $self->SetExtent(arr);
    }
...
%extend FdoXmlSpatialContextReader
{
    FdoByteArrayHandle* GetExtentBytes()
    {
        FdoPtr<FdoByteArrayHandle> ret;
